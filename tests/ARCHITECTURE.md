...
- That same contract-test entrypoint now also owns the reopened supporting guard `contract/security/test_lease_recovery_semantics_contract.py::test_security_center_projects_fresh_runtime_startup_as_aligned_clear_terminal`.
